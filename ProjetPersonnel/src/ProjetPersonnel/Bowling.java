...
public class Bowling 
{
	...
	public static void main(String[] args) 
	{
		...
		final	int		MAX_QUILLE		= 10;																		//Nombre de quille
				...
				String	strLancer		= "";																		//Affichage des résultats de lancer
					...
					if (iCtr == (MAX_CAR - 1))
					{
						if (iLancer[iCtr * 2] == MAX_QUILLE)
						{
							...
							if (iLancer[(iCtr * 2) + 1] == MAX_QUILLE)
							{
								...
								iLancer[(iCtr * 2) + 2] = Integer.parseInt(JOptionPane.showInputDialog(null, "3e lancer du carreau #" + (iCtr + 1), "Entrer le nombre de quilles tombées"));
