...
public class TabNo5 
{
	...
	public static void main(String[] args) 
	{
		...
		final	int		VIDE				= 0;																								//Constante pour remettre une variable à zéro.
				...
				boolean	bErreurSup;																												//Valide si le matricule est bon.
				boolean	bErreurVis;																												//Valide si le matricule est bon.
					...
					for (iCtr = 0 ; iCtr < iTabMat.length ; iCtr++)
					{
						if (iTabMat[iCtr] == iMat)
						{
							...
							iVerif = JOptionPane.showConfirmDialog(	null, 
									"Désirez-vous vraiment supprimer l'élève " + iTabMat[iCtr] + " " + strTabNom[iCtr] + ".", 
									"Suppression d'un élève", 
									JOptionPane.YES_NO_OPTION);
							if (iVerif == 0)
							{
								iTabMat[iCtr] 			= INACTIF;
							}
